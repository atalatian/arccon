        ...
        <IonPage className={`custom-add-modal`}>
            <IonHeader>
                <IonToolbar className={`custom-toolbar`}>
                    ...
                    <IonButtons slot="end" className={`custom-button`}>
                        <IonButton fill={`solid`}>Confirm</IonButton>
                    </IonButtons>
                </IonToolbar>
            </IonHeader>
            <IonContent className={`custom-content`}>
                <IonList inset={true} className={`custom-add-list`}>
                    ...
                    <IonItem
                        color={`transparent`}
                        className={`custom-item ion-padding-start`}
                    >
                        <IonLabel>Auftraggeber</IonLabel>
                        <IonInput
                            value={employer}
                            slot={`end`}
                            placeholder="Enter Auftraggeber"
                            onIonChange={(e) => setEmployer(e.detail.value!)}
                            clearInput
                        ></IonInput>
                    </IonItem>
                    <IonItem
                    ...
                    >
                        ...
                        <IonInput
                            value={projectId}
                            slot={`end`}
                            placeholder="Enter Projektnummer"
                    ...
                    >
                        ...
                        <IonCheckbox
                            className={`custom-add-checkbox`}
                            value={climate}
                            slot={`end`}
                            onIonChange={(e) => setClimate(e.detail.value!)}
                        ></IonCheckbox>
                    </IonItem>
                    <IonItem
                        color={`transparent`}
                    ...
                    >
                        ...
                        <IonCheckbox
                            ...
                            value={laboratory}
                            slot={`end`}
                            onIonChange={(e) => setLaboratory(e.detail.value!)}
                        ></IonCheckbox>
                    </IonItem>
                </IonList>
            </IonContent>
